...
def build_validate_prompt(state: dict) -> tuple:
    ...
    system_prompt = (
        ...
        "\n"
        "When assigning or re-classifying severity, treat SQL injection and\n"
        "user-controlled code execution (eval/exec/compile, or a shell built from\n"
        "untrusted input) as CRITICAL.\n"
        "\n"
